...
<body class="bg-gray-100 p-10 font-sans" x-data="app()">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div class="bg-indigo-600 p-6">
            <h1 class="text-2xl font-bold text-white">🎁 GiftFlow - Demo Técnica</h1>
            <p class="text-indigo-100 mt-2">Painel de Teste de API de Resgate</p>
        </div>
        ...
        <div class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button @click="redeem('GFLOW-TEST-0001')"
                    class="p-4 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition text-left group">
                    ...
                    <code class="block mt-2 text-xs bg-white p-1 rounded border border-green-100">GFLOW-TEST-0001</code>
                </button>
                ...
                <button @click="redeem('GFLOW-USED-0003')"
                    ...
                    <code
                        class="block mt-2 text-xs bg-white p-1 rounded border border-yellow-100">GFLOW-USED-0003</code>
                </button>

                <button @click="redeem('GFLOW-INVALID-XXXX')"
                    class="p-4 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 transition text-left">
                    ...
                    <code class="block mt-2 text-xs bg-white p-1 rounded border border-red-100">GFLOW-INV...</code>
                </button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <input type="email" x-model="email"
                        class="p-2 border border-gray-300 rounded focus:ring focus:ring-indigo-200 outline-none w-full">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex gap-2">
                        <input type="text" x-model="customCode" placeholder="GFLOW-..."
                            class="flex-1 p-2 border border-gray-300 rounded focus:ring focus:ring-indigo-200 outline-none">
                        <button @click="redeem(customCode)"
                            class="px-6 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 font-bold">Testar</button>
                    </div>
                </div>
            </div>

            <!-- Console Output -->
            <div class="bg-gray-900 rounded-lg p-4 font-mono text-sm h-64 overflow-y-auto shadow-inner">
                ...
                <template x-for="log in logs" :key="log.id">
                    <div class="mb-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span :class="getStatusColor(log.status)" class="font-bold px-1 rounded text-xs"
